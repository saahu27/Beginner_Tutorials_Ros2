...
class Metaclass_ChangeString(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tutorial_interfaces.srv.ChangeString')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tutorial_interfaces.srv import _change_string
...
class ChangeString(metaclass=Metaclass_ChangeString):
    from tutorial_interfaces.srv._change_string import ChangeString_Request as Request
    from tutorial_interfaces.srv._change_string import ChangeString_Response as Response
