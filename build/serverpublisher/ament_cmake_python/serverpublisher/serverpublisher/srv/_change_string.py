...
class Metaclass_ChangeString(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'serverpublisher.srv.ChangeString')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from serverpublisher.srv import _change_string
...
class ChangeString(metaclass=Metaclass_ChangeString):
    from serverpublisher.srv._change_string import ChangeString_Request as Request
    from serverpublisher.srv._change_string import ChangeString_Response as Response
