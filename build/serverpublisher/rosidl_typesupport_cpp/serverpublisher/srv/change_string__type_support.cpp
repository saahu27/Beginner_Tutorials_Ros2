...
static const _ChangeString_Request_type_support_symbol_names_t _ChangeString_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, serverpublisher, srv, ChangeString_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, serverpublisher, srv, ChangeString_Request)),
  }
};
...
{
  return &::serverpublisher::srv::rosidl_typesupport_cpp::ChangeString_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, serverpublisher, srv, ChangeString_Request)() {
  return get_message_type_support_handle<serverpublisher::srv::ChangeString_Request>();
}
...
static const _ChangeString_Response_type_support_symbol_names_t _ChangeString_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, serverpublisher, srv, ChangeString_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, serverpublisher, srv, ChangeString_Response)),
  }
};
...
{
  return &::serverpublisher::srv::rosidl_typesupport_cpp::ChangeString_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, serverpublisher, srv, ChangeString_Response)() {
  return get_message_type_support_handle<serverpublisher::srv::ChangeString_Response>();
}
...
static const _ChangeString_type_support_symbol_names_t _ChangeString_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, serverpublisher, srv, ChangeString)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, serverpublisher, srv, ChangeString)),
  }
};
...
{
  return &::serverpublisher::srv::rosidl_typesupport_cpp::ChangeString_service_type_support_handle;
}
