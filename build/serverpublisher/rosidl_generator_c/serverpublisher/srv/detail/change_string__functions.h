...
#ifndef SERVERPUBLISHER__SRV__DETAIL__CHANGE_STRING__FUNCTIONS_H_
#define SERVERPUBLISHER__SRV__DETAIL__CHANGE_STRING__FUNCTIONS_H_
 ...
 * calls
 * serverpublisher__srv__ChangeString_Request__init().
...
/**
 * It calls
 * serverpublisher__srv__ChangeString_Request__fini()
 ...
 * serverpublisher__srv__ChangeString_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * serverpublisher__srv__ChangeString_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * serverpublisher__srv__ChangeString_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_serverpublisher
...
/**
 * It calls
 * serverpublisher__srv__ChangeString_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_serverpublisher
...
/**
 * It allocates the memory for the array and calls
 * serverpublisher__srv__ChangeString_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_serverpublisher
...
/**
 * It calls
 * serverpublisher__srv__ChangeString_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SERVERPUBLISHER__SRV__DETAIL__CHANGE_STRING__FUNCTIONS_H_
