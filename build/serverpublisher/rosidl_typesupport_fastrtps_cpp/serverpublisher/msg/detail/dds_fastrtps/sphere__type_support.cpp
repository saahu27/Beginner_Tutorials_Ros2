...
#include "serverpublisher/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const serverpublisher::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<serverpublisher::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &serverpublisher::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
