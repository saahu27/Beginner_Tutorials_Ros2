...
#include "serverpublisher/msg/detail/data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const serverpublisher::msg::Data & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  serverpublisher::msg::Data & ros_message)
{
  // Member: my_data
  cdr >> ros_message.my_data;
...
{
  auto typed_message =
    static_cast<const serverpublisher::msg::Data *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<serverpublisher::msg::Data *>(
    untyped_ros_message);
...
{
  return &serverpublisher::msg::typesupport_fastrtps_cpp::_Data__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, serverpublisher, msg, Data)() {
  return &serverpublisher::msg::typesupport_fastrtps_cpp::_Data__handle;
}
