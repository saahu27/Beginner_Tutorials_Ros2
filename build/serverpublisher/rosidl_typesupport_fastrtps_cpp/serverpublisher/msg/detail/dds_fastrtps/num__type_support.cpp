...
#include "serverpublisher/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const serverpublisher::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  serverpublisher::msg::Num & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
...
{
  auto typed_message =
    static_cast<const serverpublisher::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<serverpublisher::msg::Num *>(
    untyped_ros_message);
...
{
  return &serverpublisher::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, serverpublisher, msg, Num)() {
  return &serverpublisher::msg::typesupport_fastrtps_cpp::_Num__handle;
}
